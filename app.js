console.log("--- app.js LATEST - Timestamp: " + new Date().toLocaleTimeString() + " ---");
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function showMetricInfoPopup(metricKey, iconElement) {
        ...
        if (top < 10 && (iconRect.top - popupRect.height - 5 < 10) ) { 
            top = 10; 
        }
    ...
    if (toggleSidebarBtn && sidebar && appContainer) {
        ...
        // Auto-collapse sidebar on mobile devices upon load
